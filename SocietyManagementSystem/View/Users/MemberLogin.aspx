<%@ Page Title="" Language="C#" MasterPageFile="~/View/Users/UserMasterPage.Master" AutoEventWireup="true" CodeBehind="MemberLogin.aspx.cs" Inherits="SocietyManagementSystem.View.Users.MemberLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="login_form">
        <h3 style="background: green; color: white">Member Login Panel</h3>
        <br />
        <br />
