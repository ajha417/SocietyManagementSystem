<%@ Page Title="" Language="C#" MasterPageFile="~/View/Users/UserMasterPage.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="SocietyManagementSystem.View.Users.Search" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align: center">
        ...
        <asp:Button ID="Button1" runat="server" Text="Search" Style="background: green; color: white" />
